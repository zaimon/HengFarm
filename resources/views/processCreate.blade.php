...
@section('breadcrumbs')
    ...
    {!!
      ...
      ->addCrumb('<i class="fa fa-gears fa-lg"></i> Process / <i class="fa fa-plus fa-lg"></i> Create', url()->current());
    !!}
@endsection
  ...
  <div class="x_panel">
    <div class="x_title">
      ...
      <ul class="nav navbar-right panel_toolbox">
        <a href="{{ url("project/view/$data->pjName") }}" class="btn btn-primary btn_on_title"> <i class="glyphicon glyphicon-chevron-left"></i> Back</a>  
      </ul>
    ...
    <div class="x_content">
      ...
      {!! Form::open(['action' => ['ProcessController@postCreate',$data->pjName],'method' => 'POST','class'=>'form-horizontal form-label-left']) !!}
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            {{ Form::number('cost',old('cost'), ['class' => 'form-control col-md-7 col-xs-12 '.$errors->first('cost', 'validate-red'),'autofocus']) }}
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="col-xs-8 col-xs-offset-2 col-md-4 col-md-offset-4">
            {{ Form::submit('Create Process',['class'=>'btn btn-lg btn-success btn-block']) }}
          </div>
        </div>
      {!! Form::close() !!}
